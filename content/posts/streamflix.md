...
tags: ["Design","Training","Learning","Episodic","Netflix"]
readTime: 10
downloadUrl: "/posts/streamflix/streamflix-guide.pdf"
downloadLabel: "Download the Streamflix case study"
---
![streamflix header](/static/images/streamflix/sf-header.png)
...
![streamflix header](/static/images/streamflix/sf-episode-one.png)
...
Episodes included:
1. The Vendor Gift
2. The Expense Report Shortcut
3. The File Left Open
4. Speak Up or Stay Silent
5. Finale: Everything Goes Wrong at Once

Each episode ended with a cliffhanger, leaving employees saying something no training team expects to hear:
“Wait… when does the next one come out?”

### Bonus Episode: What Made It Work

![streamflix header](/static/images/streamflix/sf-bonus-episode.png)
...
![streamflix header](/static/images/streamflix/sf-episode-two.png)
...
- Someone is about to go viral for the wrong reason
Completion rates rose because curiosity did what compliance never could.
 
### Episode Three: Training Took Over the Watercooler

![streamflix header](/static/images/streamflix/sf-episode-three.png)
...
![streamflix header](/static/images/streamflix/sf-episode-four.png)
...
![streamflix header](/static/images/streamflix/sf-episode-five.png)
...
![streamflix header](/static/images/streamflix/sf-episode-six.png)
...
![streamflix header](/static/images/streamflix/sf-finale.png)
...
![streamflix header](/static/images/streamflix/sf-footer.png)
 
<a href="/posts/streamflix/streamflix-guide.pdf" download className="btn-primary">
